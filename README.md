...
1. Clone this repo using 
   - `git clone https://github.com/beriamegha8/Sprout.git`
2. Install VScode.
3. First create the MySql database using the sql file in the repo.
4. And then build and run the LoadingScreen.java or Main.java file from the IDE. 
